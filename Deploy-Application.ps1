...
Try {
    ...
    [string]$appVendor = ''
    [string]$appName = 'Room EQ Wizard'
    [string]$appVersion = 'V5.20.13'
    [string]$appArch = 'x64'
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '09/05/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Execute-Process -Path "$dirFiles/REW_windows-x64_5_20_13.exe" -Parameters "-q"
        ...
        Copy-Item "$dirSupportFiles\REW.lnk" -Destination "$envCommonDesktop" -Force
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Remove-Item "$envCommonDesktop\REW.lnk"
        ...
        Execute-Process -Path "$envProgramFiles/REW/uninstall.exe" -Parameters "-q"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBuC+SnDBLzZYHI
# 2aiX+gDCTn1L6wdXOxVR+9VPAYBBTKCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAYpLe6+NHShzCl
# q0IX9vlc0IA3xxSATUhxfeYObN2WaDANBgkqhkiG9w0BAQEFAASCAYAT1CybFauA
# Rjf10B8e4sndt/TnlFypdkNpbPSbqZzFUiIz5NDlcuaap1EcHBZ8TP8osK1TA8tM
# MLfP6ylfdwUsmfTBiZIFkNhwxb8A06piOHjS3xPLJzjEkTOIs1EPD0qTIRLZKSRi
# Y13HwCCcC6yqJvBjnGozD9QMm1gylzt68s8MVa9bQlX8Tn8o9KJ4bBrJrZ7cR2Vb
# kzVpUkg7E1Ua3igPTVtPhj4cVv3eN39VKIawzBobQHHIKGIB6iOi052nwU4HiDFE
# GcI1K7Eh8rOVWNK1M2lLsSX/9l994RNBfw3/gBHvaGN1ULtrGfEjBMummAsTVX7Y
# CR9PGMM+Tb37hGaxGNZlyB9TCxPXHZaNkALed6/SdAtal+P59XxO7oyBZZZcuQjK
# v/jz+eUjLfyVFN3t+DK3TnXt6Sk+5O+P6MtAo4Pc0iAB4zOIFqjv6J8ojl1DZqkw
# D/4ykg/F7sSFkk1NjQDuxIjaJl9VlX3tKFTn5eYW3LL2EC1kojH1Nh2hggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwOTA1MTYz
# ODIwWjA/BgkqhkiG9w0BCQQxMgQwNca029JVQuRDROG3OEaaqD1QqoKBUxSV+6tu
# 3T3chdjyb8LTd1Icfz7SURksAv+iMA0GCSqGSIb3DQEBAQUABIICAHDOuqQ/v6s4
# 34rMH2d9XsWx4ln6ch7UrpuxEpAIp33spKKxqWD4wxgJ/9JCNTj5t3uiJ7dKB8TO
# mDf/fusX1PP6O8edQo5rvxrDpFhxj1ZadP8YfBtOFCym6ZJ7Fx2maIGBpdkNaHc0
# 5h/kKZVQKoVZTtiFzrvJS8FeSYcu46j4PLQTqIFmPOdChySaKpOB4raZj12P4Po8
# VH+w5OtFdDERXr1yrI2nkjWwbU+xmtcFHSlhrStv8bbHlsIHmRh2mXEWUEKH5ACp
# /FTWwLWc+tR7xp0JYx2Y42NsoleUiqDWgn8zlhiLiUw4/X5Z9H2h5dy8VA6ADPp1
# aSvgaPdURvmKF8DQsRqGqM3z1sDCongo0BLCFHWN7CWArHkwTfx7FdLW8YwtXgPO
# 4d+tz3QUZINvn+OxdRmDvMtFNWGjthZGx1e5jPc+huwonWMv9SBkvKWfY2SaNTdg
# NaK2tDb2VlzExfvWh02vSRlQVFCHUL2Q/5UAZsUK4sx2KjUF0NA855IATE5l661+
# eReyJWs2pXfZDA/9pgRB5bKhHWkKi2KgMU+X8cpWcgDuBTkZK0LpVuj5PL86kRuG
# M5LedbFjKaUmYPF+pMMn85PfEgqnturziDZpoDhIrwamichL/8Hfa66ScKq0uTPU
# C0pdRMxu5mWV+cFsEGHjzAj7O53qPtNh
